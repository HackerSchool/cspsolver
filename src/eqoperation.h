#ifndef EQOPERATION_H
#define EQOPERATION_H
#include "expression.h"

class VariableSet;

class EqOperation : public Expression {
private:
    Expression *_left, *_right;
public:
    EqOperation(Expression *left, Expression *right) : _left(left), _right(right), Expression() {
