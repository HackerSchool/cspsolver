...
all: $(OBJ_FILES)
	g++ $(LIB_FLAGS) $(OBJ_FILES) -o cspsolver -g
...
y.tab.o: y.tab.c 
	g++ $(LIB_FLAGS) y.tab.c -DYYDEBUG -c -g

lex.yy.o: lex.yy.c y.tab.h 
	g++ $(LIB_FLAGS) lex.yy.c -c -o $@ -g

clean: 
	rm -f src/*.o *.o *.output *tab* *yy* cspsolver test/maintest test/*.o

test/maintest: $(TEST_OBJ_FILES) $(OBJ_FILES)
	g++ $(TEST_OBJ_FILES) $(OBJ_FILES) $(TEST_LIB_FLAGS) -o test/maintest -g
